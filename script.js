...
const newObject = createCounter();
console.log(newObject.increment(8));
console.log(newObject.decrement(8));
...
const rootElement = document.getElementById("root");
const targetElement = findElementByClass(rootElement, "top__content__content");
console.log(targetElement);
